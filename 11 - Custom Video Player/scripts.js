...
progress.addEventListener('mouvemove', srub);
progress.addEventListener('mouvedown', (e) => mouvedown && scrub(e));
progress.addEventListener('mouvedown', () => mouvedown = true);
progress.addEventListener('mouveup', () => mouvedown = false);
